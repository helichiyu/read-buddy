...
![](https://img.shields.io/badge/Python-3.14-blue) ![](https://img.shields.io/badge/Version-0.1.1-green) ![](https://img.shields.io/badge/Platform-Windows-informational)
...
👉 [**下载 ReadBuddy_Setup_v0.1.1.zip**](https://github.com/helichiyu/read-buddy/releases/download/v0.1.1/ReadBuddy_Setup_v0.1.1.zip)，解压后双击安装即可。
